export function artistsHandler() {
    ...
    if (inputValue.length) {
        ...
        const stored = sessionStorage.getItem('selectedArtistsSongs');
        selectedArtists = JSON.parse(stored);
        renderSelectedArtists();

    } else {
        sessionStorage.removeItem('selectedArtistsSongs')
    }
    ...
    $('#artists').autocomplete({
        ...
        select: function (event, ui) {
            ...
            sessionStorage.setItem('selectedArtistsSongs', JSON.stringify(selectedArtists))
